...
Similar to the first test, througput of an in-memory key-value store and CPU utilization will be measured and the cluster is saturated using up to 100 clients per VM.
...
%Metric design -able to predict performance - widely applicable
