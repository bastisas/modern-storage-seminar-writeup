...
The paper uses illustration very well to explain its topics. The two graphics of Multi-Paxos' bad load balancing and of task packing in a cloud scenario help understand the concepts well.%change "graphics" to different word
